...
export const AboutUsCards = ({nombre, texto}) => {
  return (
      <article className="flex flex-col bg-arena-green-100 p-4 rounded-lg h-200 w-100 justify-start ">
        ...
        <div>
          <h3 className="text-arena-green-700 font-bold text-center text-xl mb-4"> {nombre}
          </h3>
          <p className="text-gray-400 italic text-start text-sm">
            {texto}
          </p>
        </div>
