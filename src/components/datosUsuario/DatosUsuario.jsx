...
export const DatosUsuario = () => {
  ...
  return (
    <section className="bg-bg-300 w-full h-full min-h-48 rounded-md shadow-md my-10 p-5 flex flex-col md:flex-row md:items-stretch justify-center gap-2">
        <article className="md:w-1/2 h-auto shadow-md rounded-md bg-bg-200 p-5 flex flex-col justify-around">
        ...
        <article className="md:w-1/2 h-auto shadow-md rounded-md p-5 bg-bg-200 flex flex-col justify-evenly items-center">
            <p>Tus Reservas</p>
