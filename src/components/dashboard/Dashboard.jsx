...
export const Dashboard = () => {
  return (
    ...
    <section className="w-full flex items-start justify-center space-x-5">
        {/* <!--sidenav --> */}
        <article className="w-1/3 h-screen bg-arena-green-50 p-4 z-50 rounded-lg" id="sidebar">
            ...
            <ul className="mt-4">
                ...
                <span className="text-gray-400 font-bold">VISUALES</span>
                <li className="mb-1 group">
        ...
        <article className="w-2/3 bg-arena-green-100 min-h-screen transition-all rounded-lg" id="admin-content">
        {/* <!-- Content --> */}
            <Outlet />
            {/* <div className="p-6">
