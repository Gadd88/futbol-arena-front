          ...
          ?
            horarios.map(horario => (
              <div 
                ...
                className="bg-primary-100 min-w-32 md:min-w-20 md:w-20 h-20 flex items-center justify-center rounded-xl shadow cursor-pointer relative overflow-hidden hover:bg-bg-100">
